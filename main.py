    ...
    def record(self):
        ...
        try:
            ...
            if 'play' in command:
                ...
                tts.save("audio.mp3")
                playsound("audio.mp3")
                self.output ="You said \"{}\"".format(value) +' wait sir'+ out.text
                ...
                talk('giving vision')
                self.output = "You said \"{}\"".format(value) + 'giving vison'
                os.system('ocr.bat')

            elif 'gmail'  in command:
                talk('please wait')
                self.output = "You said \"{}\"".format(value) + 'please wait'
                os.startfile('yagmail\\mail.py')
